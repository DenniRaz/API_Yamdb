...
```bash
git clone git@github.com:DenniRaz/API_Yamdb.git
cd api_yamdb
```
...
* Разуваев Денис | Github:https://github.com/DenniRaz | Тимлид, контент пользователей.
* Сергей Жуков | Github:https://github.com/Yorgankrait | Разработчик, контент администратора.
* Алексей Филин | Github:https://github.com/Bananny747 | Разработчик, кастомная модель User, регистрация и аутентификация пользователей.